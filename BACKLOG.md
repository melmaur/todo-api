...
| ID | User Story | Points | Status |
|---|---|---|---|
| US-06 | As a user I want to filter todos by status so I can focus on pending tasks | 2 |  To Do |
| US-07 | As a user I want to set a due date so I can prioritize my work | 3 |  To Do |
